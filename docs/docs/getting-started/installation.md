...
```sh
$ yarn add https://github.com/Shopify/react-native-skia/releases/download/v0.1.66-alpha/shopify-react-native-skia-0.1.66.tgz
```

Or using npm:

```sh
$ npm install https://github.com/Shopify/react-native-skia/releases/download/v0.1.66-alpha/shopify-react-native-skia-0.1.66.tgz
```
