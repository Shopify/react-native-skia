...
```sh
yarn add https://github.com/Shopify/react-native-skia/releases/download/v0.1.70-alpha/shopify-react-native-skia-0.1.75.tgz
```

Or using npm:

```sh
npm install https://github.com/Shopify/react-native-skia/releases/download/v0.1.70-alpha/shopify-react-native-skia-0.1.75.tgz
```
