...
If you're using [Expo Router](https://docs.expo.dev/router/introduction/), you can not defer the root component registration, so you'd have to load Skia using [code-splitting](#using-code-splitting).
