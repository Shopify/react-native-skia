...
If you are using v0.1.221 (recommended react-native-skia version for Expo SDK 50), you can use [`patch-package`](https://www.npmjs.com/package/patch-package) with [this patch](https://github.com/Shopify/react-native-skia/files/14357144/%40shopify%2Breact-native-skia%2B0.1.221.patch).
