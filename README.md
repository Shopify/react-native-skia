...
```sh
$ yarn add https://github.com/Shopify/react-native-skia/releases/download/v0.1.59-alpha/shopify-react-native-skia-0.1.59.tgz
```

Or using npm:

```sh
$ npm install https://github.com/Shopify/react-native-skia/releases/download/v0.1.59-alpha/shopify-react-native-skia-0.1.59.tgz
```
