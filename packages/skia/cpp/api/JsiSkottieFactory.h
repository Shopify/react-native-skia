...
public:
  ...
  JSI_HOST_FUNCTION(Make) {
    ...
    auto animation = skottie::Animation::Builder().make(str.c_str(), str.size());
    return jsi::Object::createFromHostObject(runtime, std::make_shared<JsiSkSkottie>(getContext(), std::move(animation)));
  }
