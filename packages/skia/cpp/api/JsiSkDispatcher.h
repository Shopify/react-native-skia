...
private:
  ...
  static inline std::unordered_map<std::thread::id, std::weak_ptr<DispatcherData>> _dispatcherRegistry;
...
public:
   ...
   * The operation will be executed when processQueue() is called on that thread.
   */
