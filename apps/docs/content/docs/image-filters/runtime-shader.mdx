...
<Img alt="Runtime Shader" src="/img/image-filters/runtime-shader.png" width="256" height="256" />
...
<table style={{ width: '100%' }}>
    ...
    <tr>
        <td style={{ textAlign: 'left', width: '50%' }}>
          ...
          <Img
            alt="Runtime Shader" 
            src="/img/runtime-shader/with-supersampling.png"
        ...
        <td style={{ textAlign: 'right', width: '50%' }}>
          ...
          <Img
            alt="Runtime Shader"
            src="/img/runtime-shader/without-supersampling.png"
            style={{ width: 512, height: 512 }}
          />
          </div>
        </td>
