...
void RNSkManager::registerSkiaDrawView(size_t nativeId, std::shared_ptr<RNSkView> view) {
...
void RNSkManager::setSkiaDrawView(size_t nativeId, std::shared_ptr<RNSkView> view) {
  if (!_isInvalidated && _viewApi != nullptr)
