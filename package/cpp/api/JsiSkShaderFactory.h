...
class JsiSkShaderFactory : public JsiSkHostObject {
   public:
    JsiSkShaderFactory(RNSkPlatformContext *context)
        : JsiSkHostObject(context) {
        installFunction("MakeLinearGradient", JSI_FUNC_SIGNATURE {
            ...
            for (int i = 0; i < size; i++) {
                SkColor color =
                    jsiColors.getValueAtIndex(runtime, i).asNumber();
            ...
            if (!arguments[3].isNull()) {
                auto jsiPositions =
                    arguments[3].asObject(runtime).asArray(runtime);
                auto positionsSize = jsiPositions.size(runtime);
                for (int i = 0; i < positionsSize; i++) {
                    SkColor color =
                        jsiPositions.getValueAtIndex(runtime, i).asNumber();
        ...
        installFunction("MakeRadialGradient", JSI_FUNC_SIGNATURE {
            auto center = *JsiSkPoint::fromValue(
                    runtime,
                    arguments[0].asObject(runtime)
            ).get();
            ...
            sk_sp<SkShader> gradient;
            if (count == 5) {
                gradient = SkGradientShader::MakeRadial(
                        center, r, colors.data(), positions.data(), size, tileMode);
            } else {
                auto localMatrix = arguments[5].isUndefined() || count < 6 ? nullptr : JsiSkMatrix::fromValue(runtime, arguments[5]).get();
                auto flag = count < 7 ? 0 : arguments[6].asNumber();
                gradient = SkGradientShader::MakeRadial(
                        center, r, colors.data(), positions.data(), size, tileMode, flag, localMatrix);
            }
            return jsi::Object::createFromHostObject(
                    runtime,
                    std::make_shared<JsiSkShader>(context, gradient));
        ...
        installFunction("MakeSweepGradient", JSI_FUNC_SIGNATURE {
            ...
            auto startAngle = (count < 8 || arguments[7].isUndefined()) ? 0 : arguments[7].asNumber();
        ...
        installFunction("MakeTwoPointConicalGradient", JSI_FUNC_SIGNATURE {
            auto start = *JsiSkPoint::fromValue(
                    runtime,
                    arguments[0].asObject(runtime)
            ).get();
            auto startRadius = arguments[1].asNumber();

            auto end = *JsiSkPoint::fromValue(
                    runtime,
            ...
            if (!arguments[5].isNull()) {
                auto jsiPositions =
                        arguments[5].asObject(runtime).asArray(runtime);
                auto positionsSize = jsiPositions.size(runtime);
                for (int i = 0; i < positionsSize; i++) {
                    SkColor color =
                            jsiPositions.getValueAtIndex(runtime, i).asNumber();
        ...
        installFunction("MakeTurbulence", JSI_FUNC_SIGNATURE {
            ...
            sk_sp<SkShader> gradient = SkPerlinNoiseShader::MakeTurbulence(baseFreqX, baseFreqY, octaves, seed, &size);
            return jsi::Object::createFromHostObject(
                    runtime,
                    std::make_shared<JsiSkShader>(context, gradient));
        });

        installFunction("MakeFractalNoise", JSI_FUNC_SIGNATURE {
            auto baseFreqX = arguments[0].asNumber();
            auto baseFreqY = arguments[1].asNumber();
            auto octaves = arguments[2].asNumber();
            auto seed = arguments[3].asNumber();
            ...
            auto tileH = arguments[5].asNumber();
            SkISize size = SkISize::Make(tileW, tileH);
            sk_sp<SkShader> gradient = SkPerlinNoiseShader::MakeFractalNoise(baseFreqX, baseFreqY, octaves, seed, &size);
            return jsi::Object::createFromHostObject(
                    runtime,
                    std::make_shared<JsiSkShader>(context, gradient));
        });

        installFunction("MakeBlend", JSI_FUNC_SIGNATURE {
        ...
        installFunction("MakeColor", JSI_FUNC_SIGNATURE {
