  ...
  void install(RNSkPlatformContext *context) {
    ...
    installFunction(
        "arcToRotated", JSI_FUNC_SIGNATURE {
          ...
          auto sweep = arguments[4].getBool() ? SkPathDirection::kCCW
                                              : SkPathDirection::kCW;
    ...
    installFunction(
        "computeTightBounds", JSI_FUNC_SIGNATURE {
          ...
          return jsi::Object::createFromHostObject(
              runtime, std::make_shared<JsiSkRect>(context, result));
        });
    ...
    installFunction(
        "setIsVolatile", JSI_FUNC_SIGNATURE {
    ...
    installFunction(
        "stroke", JSI_FUNC_SIGNATURE {
          ...
          if (!jsiMiterLimit.isUndefined()) {
            auto miter_limit =
                opts.getProperty(runtime, "miter_limit").asNumber();
            p.setStrokeMiter(miter_limit);
          }

          auto jsiPrecision = opts.getProperty(runtime, "precision");
          auto precision =
              jsiPrecision.isUndefined() ? 1 : jsiPrecision.asNumber();
    ...
    installFunction(
        "toSVGString", JSI_FUNC_SIGNATURE {
          SkPath path = *getObject();
          SkString s;
    ...
    installFunction(
        "makeAsWinding", JSI_FUNC_SIGNATURE {
          SkPath out;
          if (AsWinding(*getObject(), &out)) {
            return jsi::Object::createFromHostObject(
                runtime, std::make_shared<JsiSkPath>(context, out));
          }
    ...
    installFunction(
        "isEmpty",
        JSI_FUNC_SIGNATURE { return jsi::Value(getObject()->isEmpty()); });

    installFunction(
        "isVolatile",
        JSI_FUNC_SIGNATURE { return jsi::Value(getObject()->isVolatile()); });
    ...
    installFunction(
        "reset", JSI_FUNC_SIGNATURE {
          getObject()->reset();
          return jsi::Value::undefined();
        });

    installFunction(
        "rewind", JSI_FUNC_SIGNATURE {
          getObject()->rewind();
          return jsi::Value::undefined();
        });
