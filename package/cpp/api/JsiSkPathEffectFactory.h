...
namespace RNSkia {
    ...
    public:
        JsiSkPathEffectFactory(RNSkPlatformContext *context): JsiSkHostObject(context) {
            installFunction(
                    "MakeCorner", JSI_FUNC_SIGNATURE {
                        int radius = arguments[0].asNumber();
                        return jsi::Object::createFromHostObject(
                                runtime,
                                std::make_shared<JsiSkPathEffect>(context, SkCornerPathEffect::Make(radius)));
                    });
            ...
            installFunction(
                    "MakeDash", JSI_FUNC_SIGNATURE {
                        ...
                        return jsi::Object::createFromHostObject(
                                runtime,
                                std::make_shared<JsiSkPathEffect>(context, SkDashPathEffect::Make(intervals.data(), size, phase)));
                    });
            ...
            installFunction(
                    "MakeDiscrete", JSI_FUNC_SIGNATURE {
                        ...
                        return jsi::Object::createFromHostObject(
                                runtime,
                                std::make_shared<JsiSkPathEffect>(context, SkDiscretePathEffect::Make(segLength, dec, seedAssist)));
                    });
        }
    };
