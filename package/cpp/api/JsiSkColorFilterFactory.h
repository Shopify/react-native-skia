...
namespace RNSkia {
    ...
    public:
        JsiSkColorFilterFactory(RNSkPlatformContext *context): JsiSkHostObject(context) {
            installFunction(
                    "MakeMatrix", JSI_FUNC_SIGNATURE {
                        ...
                        for (int i = 0; i < 20; i++) {
                            if (jsiMatrix.size(runtime) > i) {
                                matrix[i] =
                                        jsiMatrix.getValueAtIndex(runtime, i).asNumber();
                            }
                        }
                        // Return the newly constructed object
                        return jsi::Object::createFromHostObject(
                                runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::Matrix(matrix)));
                    });
            ...
            installFunction(
                    "MakeBlend", JSI_FUNC_SIGNATURE {
                        ...
                        // Return the newly constructed object
                        return jsi::Object::createFromHostObject(
                                runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::Blend(color, blend)));
                    });
            ...
            installFunction(
                "MakeCompose", JSI_FUNC_SIGNATURE {
                    ...
                    // Return the newly constructed object
                    return jsi::Object::createFromHostObject(
                            runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::Compose(outer, inner)));
                });
            ...
            installFunction(
                "MakeLerp", JSI_FUNC_SIGNATURE {
                    ...
                    // Return the newly constructed object
                    return jsi::Object::createFromHostObject(
                            runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::Lerp(t, dst, src)));
                });
            ...
            installFunction(
                "MakeSRGBToLinearGamma", JSI_FUNC_SIGNATURE {
                    // Return the newly constructed object
                    return jsi::Object::createFromHostObject(
                            runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::SRGBToLinearGamma()));
                });
            ...
            installFunction(
                "MakeLinearToSRGBGamma", JSI_FUNC_SIGNATURE {
                    // Return the newly constructed object
                    return jsi::Object::createFromHostObject(
                            runtime, std::make_shared<JsiSkColorFilter>(context, SkColorFilters::LinearToSRGBGamma()));
                });
        }
    };
