...
export const usePathInterpolation = (
  ...
  options?: ExtrapolationType
   ...
   if (!allPathsInterpolable) {
     ...
     throw new Error("Not all paths in the output range are interpolable. See: https://shopify.github.io/react-native-skia/docs/animations/hooks#usepathinterpolation");
   }
