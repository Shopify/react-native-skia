...
export enum StrokeCap {
  Butt, //!< no stroke extension
  Round, //!< adds circle
  Square, //!< adds square
  Last = Square, //!< largest Cap value
  Default = Butt, //!< equivalent to kButt_Cap
}
...
export interface IPaint {
  ...
  setColor: (color: ProcessedColorValue | null | undefined) => void;
  setStyle: (style: PaintStyle) => void;
  setAntiAlias: (bool: boolean) => void;
  setStrokeWidth: (width: number) => void;
  setMaskFilter: (maskFilter: IMaskFilter) => void;
  setImageFilter: (imageFilter: IImageFilter) => void;
  setColorFilter: (colorFilter: IColorFilter) => void;
