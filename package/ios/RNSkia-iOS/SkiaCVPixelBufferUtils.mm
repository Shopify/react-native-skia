...
RGBFormatInfo SkiaCVPixelBufferUtils::getRGBCVPixelBufferFormatInfo(CVPixelBufferRef pixelBuffer) {
  ...
  switch (format) {
    case kCVPixelFormatType_32BGRA: [[likely]]
...
SkYUVAInfo::PlaneConfig SkiaCVPixelBufferUtils::getPlaneConfig(OSType pixelFormat) {
  switch (pixelFormat) {
    ...
    case kCVPixelFormatType_444YpCbCr16BiPlanarVideoRange: [[likely]]
...
SkYUVAInfo::Subsampling SkiaCVPixelBufferUtils::getSubsampling(OSType pixelFormat) {
  switch (pixelFormat) {
    ...
    case kCVPixelFormatType_420YpCbCr10BiPlanarVideoRange:
    case kCVPixelFormatType_420YpCbCr10BiPlanarFullRange:
    case kCVPixelFormatType_420YpCbCr8VideoRange_8A_TriPlanar: [[likely]]
...
SkYUVColorSpace SkiaCVPixelBufferUtils::getColorspace(OSType pixelFormat) {
  switch (pixelFormat) {
    case kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange:
    case kCVPixelFormatType_422YpCbCr8BiPlanarVideoRange:
    case kCVPixelFormatType_444YpCbCr8BiPlanarVideoRange: [[likely]]
      // 8-bit limited
    ...
    case kCVPixelFormatType_422YpCbCr8BiPlanarFullRange:
    case kCVPixelFormatType_444YpCbCr8BiPlanarFullRange:
    case kCVPixelFormatType_422YpCbCr8FullRange: [[likely]]
      // 8-bit full
