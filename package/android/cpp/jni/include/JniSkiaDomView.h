...
namespace RNSkia {
    ...
    class JniSkiaDomView
            : public HybridClass<JniSkiaDomView>, public JniSkiaBaseView {
    public:
        static auto constexpr kJavaDescriptor = "Lcom/shopify/reactnative/skia/SkiaDomView;";
        ...
        static void registerNatives() {
          registerHybrid({
                                 ...
                                 makeNativeMethod("surfaceAvailable",
                                                  JniSkiaDomView::surfaceAvailable),
                                 makeNativeMethod("surfaceDestroyed",
                                                  JniSkiaDomView::surfaceDestroyed),
    ...
    private:
        ...
        explicit JniSkiaDomView(jni::alias_ref<jhybridobject> jThis,
                                jni::alias_ref<JniSkiaManager::javaobject> skiaManager) :
